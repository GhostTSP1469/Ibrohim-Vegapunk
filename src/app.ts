...
export async function buildApp(opts: BuildAppOptions = {}): Promise<FastifyInstance> {
  ...
  // `hide: true` keeps this operational probe out of the OpenAPI doc — it lives
  // at the root, not under the `/api/v1` server base, so documenting it would
  // give it a wrong "Try it out" URL.
  ...
  // requests (connections), and 1:1 direct messages.
